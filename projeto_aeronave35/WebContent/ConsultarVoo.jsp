...
<td> <INPUT class="form-control" NAME="Filtro"> </td>
...
<div class="footer">
 <input type="button" name="botao"  type="submit"class="btn btn-default" value="Inserir"/> 
 <input type="button" name="botao"  type="submit"class="btn btn-default" value="Alterar"/> 
 <input type="button" name="botao"  type="submit" class="btn btn-default" value="Excluir"/> 
